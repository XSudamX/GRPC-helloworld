...
type Message struct {
	...
	Body string `protobuf:"bytes,1,opt,name=body,proto3" json:"body,omitempty"` // The format here is a string called body in the first position
}
...
var file_chat_chat_proto_rawDesc = []byte{
	...
	0x52, 0x04, 0x62, 0x6f, 0x64, 0x79, 0x32, 0x65, 0x0a, 0x0b, 0x43, 0x68, 0x61, 0x74, 0x53, 0x65,
	...
	0x00, 0x12, 0x2a, 0x0a, 0x08, 0x47, 0x72, 0x65, 0x65, 0x74, 0x69, 0x6e, 0x67, 0x12, 0x0d, 0x2e,
...
var file_chat_chat_proto_depIdxs = []int32{
	...
	0, // 1: chat.ChatService.Greeting:input_type -> chat.Message
	0, // 2: chat.ChatService.SayHello:output_type -> chat.Message
	0, // 3: chat.ChatService.Greeting:output_type -> chat.Message
...
func (c *chatServiceClient) Greeting(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Message, error) {
	out := new(Message)
	err := c.cc.Invoke(ctx, "/chat.ChatService/Greeting", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedChatServiceServer) Greeting(context.Context, *Message) (*Message, error) {
...
func _ChatService_Greeting_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Message)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ChatServiceServer).Greeting(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chat.ChatService/Greeting",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatServiceServer).Greeting(ctx, req.(*Message))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ChatService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Greeting",
			Handler:    _ChatService_Greeting_Handler,
		},
	},
